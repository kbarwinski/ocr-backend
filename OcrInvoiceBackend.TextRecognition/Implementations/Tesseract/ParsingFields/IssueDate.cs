...
{
    public class IssueDate : IParsingField
    {
        public string Name => "IssueDate";

        public int DeductionOrder => 5;
        ...
        public void DeduceFromResults(List<Detail> results)
        {
            ...
            var fromPayment = deliveryDate.Value == null || DateParsingHelper.ToDate(deliveryDate.Value) == null;
            ...
            if(targetField.Value == null || targetField.Value == "")
            {
                ...
                {
                    targetField.Value = fromPayment ? paymentDate.Value : deliveryDate.Value;
                ...
                else if (paymentType.Value != null)
                {
                    ...
                    targetField.Value = fromPayment ? paymentDateTime.Value.AddDays(-14).ToString("dd.MM.yyyy") : deliveryDate.Value;
        ...
        public async Task<Detail> ParseForField(ScanResults scanResults)
        {
            ...
            var targetPhrases = new string[] { "data wystawienia" };
